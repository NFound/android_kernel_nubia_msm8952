...
static int cyttsp5_i2c_probe(struct i2c_client *client,const struct i2c_device_id *i2c_id)
{
	...
	return rc;
release_pinctrl:
	devm_pinctrl_put(cyttsp5_pctrl.pinctrl);
	printk("cyttsp : pinctrl release.\n");
	return rc;
}
...
#endif
//MODULE_ALIAS("i2c:cyttsp5_i2c_adapter");//MODULE_ALIAS(CYTTSP568_I2C_NAME);
MODULE_LICENSE("GPL");
